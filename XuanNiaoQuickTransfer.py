...
class Ui_XuanNiaoTR(object):
    def setupUi(self, XuanNiaoTR):
        ...
        self.pushButton_setting.setStyleSheet("QPushButton {background-color: rgba(122,211,255,0);border: none}\n"
...
"QPushButton:pressed {background-color: rgb(245,245,255);color: rgb(255, 255, 255)}")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("icon/icon_setting.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.pushButton_minimizeApp.setStyleSheet("QPushButton {background-color: rgba(122,211,255,0);border: none}\n"
"QPushButton:hover {background-color: rgb(193,229,255)}QPushButton:pressed {background-color: rgb(245,245,255);color: rgb(255, 255, 255)}")
        ...
        self.pushButton_closeApp.setStyleSheet("QPushButton {background-color: rgba(122,211,255,0);border: none}\n"
"QPushButton:hover {background-color: rgb(193,229,255)}QPushButton:pressed {background-color: rgb(245,245,255);color: rgb(255, 255, 255)}")
        ...
        self.frame_medium.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_medium.setFrameShadow(QtWidgets.QFrame.Raised)
        ...
        self.frame_bottom.setStyleSheet("background-color: rgba(255,255,255,0)")
        ...
        self.pushButton_send.setStyleSheet("QPushButton {background-color: rgb(122,211,255);border-radius: 4px;border: none;color:white}\n"
"QPushButton:hover {background-color: rgb(193,229,255)}\n"
"QPushButton:pressed {background-color: rgb(245,245,255);color: rgb(255, 255, 255)}")
    ...
    def retranslateUi(self, XuanNiaoTR):
        ...
        XuanNiaoTR.setWindowTitle(_translate("XuanNiaoTR", "MainWindow"))
